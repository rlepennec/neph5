...
import { FigureSheet } from "./feature/figure/actor/figureSheet.js";
...
export class Sheets {
    ...
    static register() {
        ...
        foundry.documents.collections.Actors.registerSheet('nephilim', FigureSheet, { types: ['figure'], makeDefault: true });
