...
export class Action {
     ...
     */
    constructor(actor, token, target) {
     ...
     */
    disoriented() {
        return this.status.effects.isActive(Game.effects.desoriente);
    }
     ...
     */
    grounded() {
        return this.status.effects.isActive(Game.effects.projete);
    }
     ...
     */
    immobilized() {
        return this.status.effects.isActive(Game.effects.immobilise);
    }
     ...
     */
    hidden() {
        return this.status.effects.isActive(Game.effects.cache);
    }
     ...
     */
    covered() {
        return this.status.effects.isActive(Game.effects.couvert);
    }
    ...
    /**
     * Gets the weapon used to perform the action.
     */
    async weapon() {
        throw new Error("Abstract method 'weapon' must be implemeted");
    }
     ...
     */
    async resetCovered() {
        await this.status.effects.deactivate(Game.effects.couvert);
        return this;
    }
     ...
     */
    async resetHidden() {
        await this.status.effects.deactivate(Game.effects.cache);
        return this;
    }
