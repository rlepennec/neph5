...
export class DefenseDialog extends CombatDialog {
    ...
    _onRender(context, options) {
        ...
        this._on(this.element, "#shot6",  ["change"], (e) => this._onSelectShot(6, e));
    }

    /**
     * Handle the manoeuver change.
     * @param shot  The index of the shot on which the user has clicked, from 1 to 6.
